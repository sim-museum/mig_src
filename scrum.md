...
- **Residual:** throttle DIRECTION unverified (the slider never left its minimum during the PO's
  session, so the reading is consistent with either); **K10** still needs an elevator input in the
