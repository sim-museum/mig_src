...
- **Still to confirm with the PO:** that Replay/View now moves. The recording is provably well-formed
  and self-consistent; driving the post-flight replay UI headlessly is not yet possible, so the last
  step is a play-test rather than a claim.
